...
N 800 -360 800 -320 { lab=resistor_neg}
N 800 -510 800 -470 { lab=resistor_pos}
N 380 -260 440 -260 { lab=0}
C {devices/bsource.sym} 380 -330 0 0 {name=Broot VAR=V FUNC="sqrt(v(pressure_pos)-v(pressure_neg))"}
...
C {devices/lab_pin.sym} 800 -490 0 0 {name=l6 lab=resistor_pos}
C {devices/lab_pin.sym} 800 -340 0 0 {name=l7 lab=resistor_neg}
C {devices/ammeter.sym} 800 -450 0 0 {name=Vr1
}
C {devices/ipin.sym} 460 -510 0 0 { name=p8 lab=pressure_pos }
C {devices/ipin.sym} 460 -490 0 0 { name=p9 lab=pressure_neg }
C {devices/ipin.sym} 460 -470 0 0 { name=p11 lab=resistor_pos }
C {devices/ipin.sym} 460 -450 0 0 { name=p12 lab=resistor_neg }
