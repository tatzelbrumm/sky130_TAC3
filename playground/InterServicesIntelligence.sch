...
N 540 -500 550 -500 { lab=spike}
N 540 -500 540 -470 { lab=spike}
N 520 -520 550 -520 { lab=#net1}
N 520 -520 520 -440 { lab=#net1}
...
m=1
value=1p}
C {devices/vsource.sym} 810 -410 0 0 {name=V1 value=1.05}
C {devices/vsource.sym} 520 -410 0 0 {name=Vreset value=.95}
C {devices/iopin.sym} 450 -360 0 1 {name=p1 lab=gnd}
C {devices/switch_ngspice.sym} 890 -560 3 0 {name=Soff model=SWITCH1}
C {devices/vsource.sym} 890 -410 0 0 {name=V2 value=1}
