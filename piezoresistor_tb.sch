...
N 380 -110 410 -110 { lab=gnd}
N 380 -110 380 -90 { lab=gnd}
N 340 -90 380 -90 { lab=gnd}
N 240 -90 240 -60 { lab=gnd}
N 240 -60 440 -60 { lab=gnd}
...
C {devices/lab_pin.sym} 340 -90 0 0 {name=l2 lab=gnd}
C {devices/lab_pin.sym} 240 -180 0 0 {name=l3 lab=vres}
C {devices/lab_pin.sym} 240 -60 0 0 {name=l4 lab=gnd}
