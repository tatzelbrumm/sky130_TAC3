...
C {devices/lab_pin.sym} 390 -740 2 1 {name=p56 lab=B}
C {devices/ammeter.sym} 260 -780 0 0 {name=Vd9 current=5.7132e-04}
C {devices/lab_pin.sym} 390 -760 0 0 {name=p57 lab=G1v8}
...
.endc
" }
C {/home/ubuntulab/IC/design/sky130_TAC3/piezoresistor.sym} 560 -730 0 0 {name=x1}
